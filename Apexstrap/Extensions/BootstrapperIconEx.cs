...
namespace Apexstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconApexstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconApexstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconApexstrap => Properties.Resources.IconApexstrap,
                ...
                BootstrapperIcon.IconApexstrapClassic => Properties.Resources.IconApexstrapClassic,
                _ => Properties.Resources.IconApexstrap
            };
        }
    }
}
