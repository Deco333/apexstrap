...
using Apexstrap.AppData;
using Apexstrap.RobloxInterfaces;
using Apexstrap.UI.Elements.Bootstrapper.Base;
...
namespace Apexstrap
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"Apexstrap-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "Apexstrap-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Apexstrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingApexstrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Apexstrap.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://apexstraplabs.com/wiki/help/apexstrap-cannot-download-roblox/](https://apexstraplabs.com/wiki/help/apexstrap-cannot-download-roblox/)"),
