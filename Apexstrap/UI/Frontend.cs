...
using Apexstrap.UI.Elements.Bootstrapper;
using Apexstrap.UI.Elements.Dialogs;

namespace Apexstrap.UI
{
    static class Frontend
    {
        ...
        public static void ShowPlayerErrorDialog(bool crash = false)
        {
            ...
            string info = String.Format(
                ...
                $"https://apexstraplabs.com/wiki/help/roblox-crashes-or-does-not-launch/"
            );
        ...
        private static IBootstrapperDialog GetCustomBootstrapper()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!App.LaunchSettings.QuietFlag.Active)
                    ShowMessageBox(string.Format(Strings.CustomTheme_Errors_SetupFailed, ex.Message, "Apexstrap"), MessageBoxImage.Error); // NOTE: Apexstrap is the theme name
        ...
        public static void ShowBalloonTip(string title, string message, System.Windows.Forms.ToolTipIcon icon = System.Windows.Forms.ToolTipIcon.None, int timeout = 5)
        {
            ...
            {
                Icon = Properties.Resources.IconApexstrap,
