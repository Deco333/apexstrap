...
namespace Apexstrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["ApexstrapCustomBootstrapper"] = HandleXmlElement_ApexstrapCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "ApexstrapCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "ApexstrapCustomBootstrapper");
            ...
            switch (version)
            {
                ...
                case 0: // Themes made between Oct 19, 2024 to Mar 11, 2025 (on the feature/custom-bootstrappers branch)
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "ApexstrapCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "ApexstrapCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "ApexstrapCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "ApexstrapCustomBootstrapper");
            ...
            // handle root
            HandleXmlElement_ApexstrapCustomBootstrapper(this, xml);
