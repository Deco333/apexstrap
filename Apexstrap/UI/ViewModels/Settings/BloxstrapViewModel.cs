...
{
    public class ApexstrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Apexstrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "ApexstrapViewModel::AddFilesToZipStream";
