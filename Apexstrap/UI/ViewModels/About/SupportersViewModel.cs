...
namespace Apexstrap.UI.ViewModels.About
{
    public class SupportersViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async void LoadSupporterData()
        {
            ...
            try
            {
                SupporterData = await Http.GetJson<SupporterData>("https://raw.githubusercontent.com/apexstraplabs/config/main/supporters.json");
            }
            catch (Exception ex)
            {
