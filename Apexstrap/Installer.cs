...
namespace Apexstrap
{
    internal class Installer
    {
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs apexstrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Apexstrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Apexstrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                {
                    ...
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Apexstrap-v{releaseNoteVersion}");
                }
