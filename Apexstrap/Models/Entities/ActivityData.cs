...
using Apexstrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Apexstrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for apexstraprpc, discord rich presence, or game history
