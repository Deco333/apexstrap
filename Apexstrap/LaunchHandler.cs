...
namespace Apexstrap
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchInstaller()
        {
            ...
            {
#if QA_BUILD
                Frontend.ShowMessageBox("You are about to install a QA build of Apexstrap. The red window border indicates that this is a QA build.\n\nQA builds are handled completely separately of your standard installation, like a virtual environment.", MessageBoxImage.Information);
#endif
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "Apexstrap-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "Apexstrap-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
