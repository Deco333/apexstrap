...
namespace Apexstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Apexstrap-QA";
#else
        public const string ProjectName = "Apexstrap";
#endif
        public const string ProjectOwner = "Apexstrap";
        public const string ProjectRepository = "apexstraplabs/apexstrap";
        public const string ProjectDownloadLink = "https://apexstraplabs.com";
        public const string ProjectHelpLink = "https://apexstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/apexstraplabs/apexstrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructApexstrapWebUrl();
        ...
        public static string ConstructApexstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.apexstraplabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.apexstraplabs.com";
        }
